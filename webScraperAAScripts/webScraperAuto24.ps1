param(
    ...
    $domain = "autoplius.lt",
    $htmlPath = "$rootPath\report\autoplius_caravan_$((get-date).tostring('dd_MM_yyyy')).html",
    $htmlPathMoto = "$rootPath\report\autoplius_moto_$((get-date).tostring('dd_MM_yyyy')).html",
...
$command = @'
    ...
    Enter-SeUrl 'https://lv.autoplius.lt/sludinajumi/autobusi-mikroautobusi-turistu-majinas' -Driver $Driver
...
# get pages
# $models = 'fiat', 'ford', 'volkswagen', 'mercedes-benz'
# $pages = @()
# foreach ($model in $models) {
#     $uri = "https://lv.autoplius.lt/sludinajumi/autobusi-mikroautobusi-turistu-majinas/turistu-automasinas-kemperi/$($model)?category_id=29&slist=1862616329&order_by=1&order_direction=DESC"
#     $uri
...
$pages = ''
$uri = 'https://lv.autoplius.lt/sludinajumi/autobusi-mikroautobusi-turistu-majinas/turistu-automasinas-kemperi?category_id=29&slist=1862616329&order_by=1&order_direction=DESC'
$WebRequest = Invoke-WebRequest -UseBasicParsing -Uri $uri -WebSession $session `
                                    -Headers @{
                                "authority"="lv.autoplius.lt"
                                "method"="GET"
